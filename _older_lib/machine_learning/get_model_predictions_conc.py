from machine_learning.get_X_y_arrays import get_X_y_arrays_conc
import pandas as pd

def get_model_predictions_6_conc(model_dict, input_df):
    model_predictions = {}
...
def get_model_predictions_7_conc(model_dict, input_df):
    model_predictions = {}
